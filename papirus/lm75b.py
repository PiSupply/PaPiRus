# Minimal support for LM75b temperature sensor
# on the Papirus HAT / Papirus Zero.
#
# This module allows you to read the temperature.
#
# The OS-output (Over-temperature Shutdown) connected to
# GPIO xx (pin 11) is not supported by this module
#
...
class LM75B(object):
    def __init__(self, address=LM75B_ADDRESS, busnum=1):
        ...
        self._bus.write_byte_data(self._address, LM75B_CONF_REGISTER,
                                  LM75B_CONF_NORMAL)
